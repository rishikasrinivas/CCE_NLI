...
python3 code/activation.py --model_type bowman --save_masks_dir activations/bowman/wanda/RunBowmanWandaReformatted --prune_metrics_dir models/snli/prune_metrics/wanda/bowman/TestingBowman
