...
def create_dataloaders(max_data, reduced=False):
    root_dir="models/DataLoaders/"
    if (not reduced and not ('train_dataset.pth' in os.listdir(root_dir) and 'val_dataset.pth' in os.listdir(root_dir) and 'test_dataset.pth' in os.listdir(root_dir))):
        ...
        torch.save(train_loader.dataset, f'{root_dir}/train_dataset_50.pth')
        ...
        torch.save(val_loader.dataset, f'{root_dir}/val_dataset_50.pth')
        ...
        torch.save(test_loader.dataset, f'{root_dir}/test_dataset_50.pth')
    else:
