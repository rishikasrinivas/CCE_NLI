...
python3 code/pruning_explanation.py --model_type bert --filename Run0.25 --pruning_method wanda --ckpt BERT/models/Run0.25/lottery_ticket/3_Pruning_Iter/model_best.pth