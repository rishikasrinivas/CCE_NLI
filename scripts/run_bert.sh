...
python3 code/lotteryTicket/snli_lottery_ticket_training.py  --model_type bert --filename Run0.25_2  --i 2 --finetune_epochs 3 --restart_from_ckpt 2
...
python3 code/pruning_explanation.py --model_type bert --filename Run0.25_2 --pruning_method wanda --ckpt BERT/models/Run0.25_2/lottery_ticket/0_Pruning_Iter/model_best.pth